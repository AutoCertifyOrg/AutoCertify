...
export default function RegularUserSearch() {
  ...
  const handleSearch = (vinToSearch: string) => {
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Vehicle Found",
        description: `Found vehicle with VIN: ${vinToSearch}`,
      })
    }, 1500)
  }
    ...
    <DashboardLayout>
      <div className="flex flex-col gap-8 p-4 md:p-8">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground">Search for basic vehicle information using a VIN number.</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter a Vehicle Identification Number (VIN) to retrieve basic vehicle information.
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Basic details about the vehicle with VIN: {vehicleInfo.vin}</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-muted/30 border-dashed">
              <CardHeader>
                ...
                <CardDescription>Detailed vehicle history and records</CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col items-center justify-center p-6">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Upgrade to Premium to unlock the full vehicle report including crash history, service records, and
                    ownership history.
                  </p>
        ...
        <Alert>
          ...
          <AlertDescription>
            As a Regular User, you have access to basic vehicle information only. Upgrade to Premium to access full
            vehicle history reports including crash records, service history, and ownership transfers.
          </AlertDescription>
        </Alert>
      </div>
    </DashboardLayout>
